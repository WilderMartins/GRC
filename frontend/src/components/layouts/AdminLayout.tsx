...
export default function AdminLayout({ children, title = 'Painel Administrativo - Phoenix GRC' }: AdminLayoutProps) {
  // TODO: Adicionar estado para sidebar (aberto/fechado), usuário logado, etc.
        ...
        <aside className="w-64 bg-white p-6 shadow-md dark:bg-gray-800 hidden md:block">
          ...
          <nav>
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/admin/identity-providers">
                  <span className="block rounded-md px-4 py-2 text-gray-700 hover:bg-indigo-500 hover:text-white dark:text-gray-300 dark:hover:bg-indigo-600">
              ...
              <li>
                <Link href="/">
                  <span className="block rounded-md px-4 py-2 text-gray-700 hover:bg-red-500 hover:text-white dark:text-gray-300 dark:hover:bg-red-600 mt-10">
                    Sair (Voltar ao Site)
                  </span>
                </Link>
              </li>
          ...
          <header className="bg-white shadow-sm dark:bg-gray-800 p-4">
            <div className="flex items-center justify-between">
              <h1 className="text-xl font-semibold text-gray-800 dark:text-white">
                {/* O título da página pode vir aqui dinamicamente */}
                Painel Administrativo
              </h1>
              <div className="flex items-center space-x-3">
                {/* Placeholder para ícone de notificações, perfil do usuário */}
                <span className="text-gray-600 dark:text-gray-400">Usuário Admin</span>
                <button className="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700">
                  {/* Ícone de Logout ou Perfil */}
